...
class LocationActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateButtonStyle(binding.pickLocation, false)
        setActions()
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.setOnMapClickListener {
            ...
            updateButtonStyle(binding.pickLocation, true)
        }
    }
    ...
    private fun updateButtonStyle(button: Button, isEnabled: Boolean) {
        if (isEnabled) {
            ...
            button.setTextColor(ContextCompat.getColor(this, R.color.purple_black))
            button.isEnabled = true
        } else {
            // Mengaktifkan style buttonDisabled
            button.setBackgroundColor(ContextCompat.getColor(this, R.color.purple_black))
